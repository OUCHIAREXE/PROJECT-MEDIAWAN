...
<nav class="navbar navbar-expand-lg navbar-light " style="direction:rtl;zoom: 1.2;animation: fadeIn;animation-duration: 0.8s;position: sticky;top: 0;width: 100%;
background: linear-gradient(90deg, rgba(26,26,50,1) 22%, rgba(46,45,89,1) 100%);
;z-index: 9;height: 53px;">
        <a class="navbar-brand" id="logo_1" href="#" style="font-family: 'Montserrat', sans-serif;color:#fff;animation: glow 2s ease-in-out infinite;" >MEDIWAN</a>
      ...
      <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
          ...
          <div class="col-lg-6" >
            ...
            <div class="">
             <center>
             <button type="button" class="btn btn-custom" style="background-color:#5555af;color:#fff;font-family: 'Tajawal', sans-serif;position: relative; margin: auto;    zoom: 1.6;
  ...
  <div class="abt_us">
   ...
   <div class="section_title"><h1 id="sec">ما هي الخدمات التي تقدمها </h1><h1 href="#" style="font-family: 'Montserrat', sans-serif;color:#fff;">MEDIWAN</h1></div>
   <br/>        
...
">
   ...
   <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        <img src="img/3.png" class="img-fluid" style="mix-blend-mode: multiply;" >
    ...
    <div class="row">
      ...
      <div class="col-sm-8">
        ...
        <p style="direction: rtl;  text-align: initial; font-family: 'Tajawal', sans-serif; color: #fff; font-size: 22px;"> يعمل فريق MEDIAWAN على وضع إستراتيجية شاملة للتسويق لمنتجك أو خدمتك تتوافق مع أهداف مشروعك و تضمن لك النتائج التي تطمح لها باستعمال وسائل و تقنيات متطورة جدا في مجال التسويق الإلكتروني
          ...
          <button type="button" data-toggle="modal" data-target="#exampleModal" class="btn btn-custom" style="background-color:#5555af;color:#fff;font-family: 'Changa', sans-serif;margin-right: 51px;
                margin-top: 5px;zoom:1.8;float:left;">إحجز مكالمتك الأن</button>
      </div></div>
    </div>
    </div>
  </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="section_title"><h3 style="color:#2e2d59;text-align:center;">صور لبعض نتائجنا التسويقية الناجحة</h3></div>
             <br>
              ...
              <div class="col-sm-6">
                <div class="section_title"><h1 style="color:#2e2d59;text-align:center;">نتائج عملائنا تبرهن كل شيء</h1></div>
                <p style="margin-right: 10px;direction: rtl;  text-align: initial; font-family: 'Tajawal', sans-serif; color: #2e2d59; font-size: 22px;">يمكنك قراءة أرباح واحد من أهم المشاريع التي طورتها الوكالة 
            ...
            <br/> <br/>   <br/>
            <div class="section_title"><h1 style="color:#2e2d59;text-align:center;"> لماذا عليك أن تدع فريق MEDIAWAN</h1></div>
            <div class="section_title"><h3 style="color:#2e2d59;text-align:center;"> يعمل على ما هو بارع فيه لتحصل على النتائج التي لطالما بحثت عنها ؟</h3></div>
          </div> 
          </div> 
          <br/>
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-8">
                   <p style="direction: rtl;  text-align: initial; font-family: 'Tajawal', sans-serif; color: #2e2d59; font-size: 22px;">
                    من أهدافنا الأساسية:
                  </p>
                  <p style="direction: rtl;  text-align: initial; font-family: 'Tajawal', sans-serif; color: #2e2d59; font-size: 22px;"> <i class="bi bi-check2"></i> 		نتائج أرباحك مضمونة
                  </p>
                  <p style="direction: rtl;  text-align: initial; font-family: 'Tajawal', sans-serif; color: #2e2d59; font-size: 22px;"> <i class="bi bi-check2"></i> 		توفير مالك و وقتك
                  </p>
                  <p style="direction: rtl;  text-align: initial; font-family: 'Tajawal', sans-serif; color: #2e2d59; font-size: 22px;"> <i class="bi bi-check2"></i> 		تقديم خدماتنا بأسعار مناسبة
                  </p>
                  <p style="direction: rtl;  text-align: initial; font-family: 'Tajawal', sans-serif; color: #2e2d59; font-size: 22px;"> <i class="bi bi-check2"></i> 	وسيع مشروعك في وقت وجيز
                  </p>
                  <p style="direction: rtl;  text-align: initial; font-family: 'Tajawal', sans-serif; color: #2e2d59; font-size: 22px;"> <i class="bi bi-check2"></i> تقديم خدمة عملاء ذات جودة عالية
                  </p>
        </div>
      </div>
        ...
        <div class="row" style="padding: 8px;">
          <div class="col-sm-8">
            <div class="section_title"><h4 style="direction: rtl;
              text-align: initial;"> ابدء تسلق سلم نجاح مشروعك    </h4></div>
          ...
          ">
              <div class="questions-body">
                <div class="section_title"><h1 style="color:#2e2d59;text-align:center;">أسئلة شائعة</h1></div>
<br/>
<center>
  <div class="card" style=" width: 75%; background: #2e2d59; color: #fff; font-family: 'Tajawal', sans-serif; ">
    <div class="card-body" style=" height: 163px; ">
      <div id="carouselContent" class="carousel slide" data-ride="carousel">
        ...
        margin-right: 64px;
    " href="#carouselContent" role="button" data-slide="prev" >
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
            <span class="sr-only">Next</span>
        </a>
    </div>
    ...
    <div id="card-icon" style=" font-size: 150px; "><i class="bi bi-quote" style="
      position: absolute;
      right: 0;
      bottom: 0;
      opacity: 0.05;
...
<div class="section_title"><h1 style="color:#2e2d59;text-align:center;">بعض عملائنا</h1></div>
...
<div class="card" style=" width: 75%; background: #2e2d59; color: #fff; font-family: 'Tajawal', sans-serif;margin:auto; ">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        <button type="button" data-toggle="modal" data-target="#exampleModal" class="btn btn-custom" style="background-color:#5555af;color:#fff;font-family: 'Changa', sans-serif;margin-right: 51px;
                margin-top: 5px;zoom:1.8;animation:heartBeat;animation-duration: 0.9s; animation-iteration-count: 3;">إحجز مكالمتك الأن</button>
      </div>
      <div class="col-sm-8">
        <h2 style="float:right;">  ? هل أنت جاهز لتكون ضمن أهم عملائنا</h2>
        <p style="float:right;">احجز حصة مجانية مع أحد المختصين من فريقنا لتحديد الإستراتيحية المناسبة لمنتجك
...
<div class="card" style=" width: 75%; background: #2e2d59; color: #fff; font-family: 'Tajawal', sans-serif;margin:auto; ">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        <h2 style="float:right;">  هل لديك استفسار عام؟</h2>
        <p style="float:right;direction: rtl;text-align: initial;">إذا كان لديك استفسار عام وترغب في التحدث إلى فريق الخبراء لدينا، يمكنك الاتصال بنا عبر البريد الإلكتروني
